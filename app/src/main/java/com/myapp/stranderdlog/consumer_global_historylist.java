...
public class consumer_global_historylist extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consumer_global_historylist);
        ...
        Collections.sort(readings, new CustomComparator3());
...
class CustomComparator3 implements Comparator<String> {
